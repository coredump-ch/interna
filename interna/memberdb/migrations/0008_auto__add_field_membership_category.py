...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Membership.category'
        db.add_column(u'memberdb_membership', 'category',
                      self.gf('django.db.models.fields.PositiveSmallIntegerField')(null=True),
                      keep_default=False)
        db.alter_column(u'memberdb_member', 'category', models.PositiveSmallIntegerField(null=True))


    def backwards(self, orm):
        # Deleting field 'Membership.category'
        db.delete_column(u'memberdb_membership', 'category')
        db.alter_column(u'memberdb_member', 'category', models.PositiveSmallIntegerField(null=False))
